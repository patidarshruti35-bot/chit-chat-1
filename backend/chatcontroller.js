...
const createGroupChat = asyncHandler( async (req,res) => {
    ...
    if(users.length<2){
        return res.status(400).send("Add atleast 2 users to create a group chat");
    }
...
const removeFromGroup = asyncHandler( async (req,res) => {
    ...
    //     return res.status(403).send("You are the group admin");
    // }
    // else if(chat.groupAdmin.toString() !== req.user._id.toString()){
